...
- 📋 **Eyeball the first automated social run's captions across all 6 platforms** — the caption hook prompt affects every automated post (staging-verified, prod not yet observed)
