# The Practice Treatment Plan — Master Pitch Narrative

**Status: DRAFT v1 for review — 2026-08-04**

The single source of truth for the funnel's pitch. Derives into:
1. **The PDF** ("The Practice Treatment Plan", sent by nurture email #1 via trigger link)
2. **The walkthrough video script** (12 min, chapters must match /walkthrough page)
3. **Nurture email spine** (each email re-opens one section, with the lead's personal numbers)

Style: Oren Klaff, *Pitch Anything*. Frame control, the Big Change (three forces),
belief shift, named mechanism, prize frame, one ask. No fake scarcity, no income
claims — the confidence comes from the frame, not from invented numbers.
Personal numbers (their leak, their scores) are NEVER baked into this universal
copy — they live in the surrounding email ("Your drift leak came in at $X —
the treatment plan explains where it goes").

---

## 1 · THE FRAME (cold open)

An X-ray doesn't lie.

It doesn't exaggerate, it doesn't flatter, and it doesn't care how long you've
...
## 2 · THE BIG CHANGE (why this is happening to good practices)
...
## 3 · THE BELIEF SHIFT (why effort can't fix it)
...
twelve visits of it. The whole system costs $397 a month.
...
- 0:30 Ch.1 Retention & Recall — §3 drift + Recall demo (screen)
