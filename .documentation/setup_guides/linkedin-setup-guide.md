...
Use this checklist to connect your LinkedIn presence to Levercast. You can link both your personal profile and (once approved) company pages.
...
2. **Connect Personal Profile (optional but recommended)**
   ...
   - You’ll return to Levercast; status should show “Connected as …”.
...
- **Connection lost:** disconnect in Levercast, then reconnect. Tokens expire periodically; reauthorization refreshes them.
...
## Next Steps
- Once connected, drafting or scheduling LinkedIn posts in Levercast will target the selected profile/page automatically.
