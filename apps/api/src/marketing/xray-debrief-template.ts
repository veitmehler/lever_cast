...
<style>
  :root {
    ...
    --ink: #FFFFFF; --dim: #A0A0A5; --faint: #6E6E74;
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .eyebrow {
    font-family: var(--mono); font-size: 9.5pt; letter-spacing: 0.26em;
...
<div class="page" style="justify-content: center;">
  ...
  <div style="font-family: var(--mono); font-size: 9.5pt; letter-spacing: 0.22em; text-transform: uppercase; color: var(--dim); margin-top: 0.35in;">
...
<div class="page">
  ...
  <div class="film">
    <div class="dialwrap">
      ...
      <div class="dialcap">
        <div class="lbl">Practice Autopilot Score &middot; ${d.preparedFor}</div>
...
<div class="page">
  ...
  <h2 class="sect">Why this is happening<br />to good practices.</h2>
