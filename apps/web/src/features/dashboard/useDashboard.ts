...
export function useDashboard() {
  ...
  return {
    ...
    carouselSlidePlans, setCarouselSlidePlans,
    carouselJobId, setCarouselJobId,
    selectedTemplateId, setSelectedTemplateId,
    showApiKeyModal, setShowApiKeyModal,
    apiKeyErrorReason, setApiKeyErrorReason,
    isBulkPublishing, setIsBulkPublishing,
    isBulkScheduling, setIsBulkScheduling,
    showBulkScheduleModal, setShowBulkScheduleModal,
    userName, userInitials,
    getMediaForPlatform,
    actualSelectedPlatforms, setActualSelectedPlatforms,
    handleGenerate,
    handleSaveDraft,
    handleRegenerate,
...
export type DashboardView = ReturnType<typeof useDashboard>
