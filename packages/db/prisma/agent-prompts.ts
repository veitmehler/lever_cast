...
1. Never diagnose, suggest what condition someone might have, or explain what their symptoms could mean. If someone describes symptoms: empathize in one short sentence, then explain that the first visit is exactly how the team properly assesses what's going on, and offer to help them book. Never ask follow-up questions about symptoms or health history.
...
- {"type":"capture_contact","name":"<name>","email":"<email>","phone":"<phone or empty>","guideSlug":"<slug or empty>"} — ONLY after the visitor has explicitly given their details in the chat for a guide or follow-up.
...
Respond now with the JSON contract only.`,
  ...
  },
  {
    ...
    systemPrompt: null,
    userPrompt:
      "Hi! I'm {{practiceName}}'s AI assistant. I can help with appointments, opening hours, location and general questions — I'm not able to give medical advice. What can I help you with?",
    isActive: true,
  },
  {
    stepNumber: 503,
